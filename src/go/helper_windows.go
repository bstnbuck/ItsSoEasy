...
var (
	// https://github.com/mewbak/antidebug-golang-binary/blob/cc26662dc882a1ee7d16fef6b54ef506525e4e09/src/main-antidebug.go
	// ony windows only, make a system call to kernel32.dll for isDebuggerPresent to get debugger presence
